                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="title" type="text" class="form-control" name="title" placeholder="Title" value="{{ $contest->title }}">
                                </div>              
                                ...
                                <div class="input-group date form_datetime_begin">
                                    ...
                                    <input id="begin_time" size="16" type="text" name="begin_time" class="form-control" value="{{ $contest->begin_time }}">
                                ...
                                <div class="input-group">
                                    <span class="input-group-addon">Begin Time</span>
                                    <input id="begin_time" size="16" type="text" name="begin_time" class="form-control" value="{{ $contest->begin_time }}" readonly>
                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                </div>
                                <span class="help-block-xs">Cannot change after the contest begin.</span>
                                @endif
                                ...
                                <div class="input-group">
                                  ...
                                  <input id="duration" size="16" type="text" name="duration" class="form-control" value="5:00:00">
                                ...
                                <div class="input-group date form_datetime_end">
                                    ...
                                    <input  id="end_time" size="16" type="text" name="end_time" class="form-control" value="{{ $contest->end_time }}"> 
                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="password" placeholder="Leave it blank if not needed" value="{{ $contest-> password }}">
                                </div>

                                <br>
                                        
                                <textarea class="form-control" rows="5" name="description" placeholder="put contest description here~">{{ $contest->description }}</textarea>
                                            ...
                                            <tr class="tr_problem">
                                                ...
                                                <td>
                                                    <select name="OJs" class="form-control input-sm">
                                                        @foreach ($OJs as $key1 => $value1)
                                                            @if ($value->origin_oj == $key1)
                                                ...
                                                <td><input type="text" name="probNums" style="width:70px" class="form-control input-sm" value="{{ $value->origin_id }}"></td>
                                                <td><input class="protitles form-control input-sm" name="protitles[]" value="{{ $value->title }}"></td>
...
$(function() {
    $('#submit').click(function() {
        ...
        $.ajax({
            type: 'post',
            dataType: 'JSON',
            url: '{{ route('contest.update', ['id' => $contest->id]) }}',
            data: $("form").serialize(),
            success: function(data){
                $btn.button('reset');
                self.location="{{ route('contest.show', ['id' => $contest->id]) }}";
            },
            error: function(data) {
                $btn.button('reset');
